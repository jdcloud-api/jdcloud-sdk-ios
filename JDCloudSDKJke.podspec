Pod::Spec.new do |s|
  ...
  s.name         = "JDCloudSDKJke"
  s.version      = "0.0.3"
  s.summary      = "JD Cloud Open API Swift SDK Jke"
 
  s.description  = <<-DESC
    JDCloud Open API Swift SDK Jke framework
  DESC
  ...
  s.source_files  = "Sources/JDCloudSDKJke", "Sources/JDCloudSDKJke/**/*.{h,swift}"
 

  s.public_header_files = "Sources/JDCloudSDKJke/*.h"
