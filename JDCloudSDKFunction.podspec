Pod::Spec.new do |s|
  ...
  s.name         = "JDCloudSDKFunction"
  s.version      = "0.0.6"
  s.summary      = "JD Cloud Open API Swift SDK Function"
 
  s.description  = <<-DESC
    JDCloud Open API Swift SDK Function framework
  DESC
  ...
  s.source_files  = "Sources/JDCloudSDKFunction", "Sources/JDCloudSDKFunction/**/*.{h,swift}"
 

  s.public_header_files = "Sources/JDCloudSDKFunction/*.h"
