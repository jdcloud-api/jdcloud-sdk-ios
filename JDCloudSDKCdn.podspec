Pod::Spec.new do |s|
  ...
  s.name         = "JDCloudSDKCdn"
  s.version      = "0.0.4"
  s.summary      = "JD Cloud Open API Swift SDK Cdn"
 
  s.description  = <<-DESC
    JDCloud Open API Swift SDK Cdn framework
  DESC
  ...
  s.source_files  = "Sources/JDCloudSDKCdn", "Sources/JDCloudSDKCdn/**/*.{h,swift}"
 

  s.public_header_files = "Sources/JDCloudSDKCdn/*.h"
