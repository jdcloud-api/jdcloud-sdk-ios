Pod::Spec.new do |s|
  ...
  s.name         = "JDCloudSDKCr"
  s.version      = "0.0.3"
  s.summary      = "JD Cloud Open API Swift SDK Cr"
 
  s.description  = <<-DESC
    JDCloud Open API Swift SDK Cr framework
  DESC
  ...
  s.source_files  = "Sources/JDCloudSDKCr", "Sources/JDCloudSDKCr/**/*.{h,swift}"
 

  s.public_header_files = "Sources/JDCloudSDKCr/*.h"
