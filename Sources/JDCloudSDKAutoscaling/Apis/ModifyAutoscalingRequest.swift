...
///  修改弹性伸缩详情（AG属性）
public class ModifyAutoscalingRequest:JdCloudRequest
{
    /// 最大实例数
    var maxSize:Int64?
    ...
    enum ModifyAutoscalingRequestRequestCodingKeys: String, CodingKey {
        case maxSize
        case minSize
    ...
    public override func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: ModifyAutoscalingRequestRequestCodingKeys.self)
