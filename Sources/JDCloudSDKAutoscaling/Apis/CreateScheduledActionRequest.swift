...
///  创建伸缩组定时策略
public class CreateScheduledActionRequest:JdCloudRequest
{
    /// 实例数量
    var amount:Int64
    ...
    public init(regionId: String,amount:Int64,name:String,recurrence:Int64,scaleType:Int64,startTime:String,asGroupUuid:String){
        self.amount = amount
        self.name = name
    ...
    enum CreateScheduledActionRequestRequestCodingKeys: String, CodingKey {
        case amount
        case dayInterval
        case description
        case endTime
    ...
    public override func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: CreateScheduledActionRequestRequestCodingKeys.self)
