...
///  修改伸缩组动态策略
public class ModifyDynamicPolicyRequest:JdCloudRequest
{
    ...
    /// 动态策略uuid
    var dynamicPolicyUuid:String


    public init(regionId: String,action:Int64,actionValue:Int64,actionValueType:Int64,calculation:String,cooldownPeriod:Int64,metric:String,name:String,operation:String,period:Int64,threshold:Double,times:Int64,asGroupUuid:String,dynamicPolicyUuid:String){
        self.action = action
        ...
        self.dynamicPolicyUuid = dynamicPolicyUuid
        super.init(regionId: regionId)
    }


    enum ModifyDynamicPolicyRequestRequestCodingKeys: String, CodingKey {
        case action
        case actionValue
        ...
        case times
        case asGroupUuid
        case dynamicPolicyUuid
    }

    public override func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: ModifyDynamicPolicyRequestRequestCodingKeys.self)
        ...
        try container.encode(dynamicPolicyUuid, forKey: .dynamicPolicyUuid)
