...
///  导出流量数据
      ...
      ///       /// 
@objc(ExportLiveStreamTrafficDataRequest)
public class ExportLiveStreamTrafficDataRequest:JdCloudRequest
{
    ...
    enum ExportLiveStreamTrafficDataRequestRequestCodingKeys: String, CodingKey {
        case domainName
        case appName
        case streamName
        case ispName
    ...
    public override func encode(to encoder: Encoder) throws {
        var encoderContainer = encoder.container(keyedBy: ExportLiveStreamTrafficDataRequestRequestCodingKeys.self)
