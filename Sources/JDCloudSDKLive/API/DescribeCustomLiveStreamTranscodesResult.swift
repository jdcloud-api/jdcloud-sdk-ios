...
/// 查询用户自定义转码模板列表
@objc(DescribeCustomLiveStreamTranscodesResult)
public class DescribeCustomLiveStreamTranscodesResult:NSObject,JdCloudResult
{
    /// 当前页码
    var pageNumber:Int?
    ...
    enum DescribeCustomLiveStreamTranscodesResultCodingKeys: String, CodingKey {
        case pageNumber
        case pageSize
        case totalCount
        case transcodeTemplateList
    }
...
public extension DescribeCustomLiveStreamTranscodesResult{
    public func encode(to encoder: Encoder) throws {
        var encoderContainer = encoder.container(keyedBy: DescribeCustomLiveStreamTranscodesResultCodingKeys.self)
        try encoderContainer.encode(pageNumber, forKey: .pageNumber)
        try encoderContainer.encode(pageSize, forKey: .pageSize)
        try encoderContainer.encode(totalCount, forKey: .totalCount)
        try encoderContainer.encode(transcodeTemplateList, forKey: .transcodeTemplateList)
    }
}
