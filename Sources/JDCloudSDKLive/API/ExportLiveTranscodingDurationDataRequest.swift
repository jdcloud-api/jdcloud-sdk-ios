...
///  导出转码时长数据
@objc(ExportLiveTranscodingDurationDataRequest)
public class ExportLiveTranscodingDurationDataRequest:JdCloudRequest
{
    ...
    enum ExportLiveTranscodingDurationDataRequestRequestCodingKeys: String, CodingKey {
        case grade
        case period
        case startTime
        case endTime
    ...
    public override func encode(to encoder: Encoder) throws {
        var encoderContainer = encoder.container(keyedBy: ExportLiveTranscodingDurationDataRequestRequestCodingKeys.self)
