...
///  查询录制文件列表
      ///       /// 
@objc(DescribeLiveRecordFilesRequest)
public class DescribeLiveRecordFilesRequest:JdCloudRequest
{
    /// 当面页数
      /// 
    var pageNum:Int
    ...
    enum DescribeLiveRecordFilesRequestRequestCodingKeys: String, CodingKey {
        case pageNum
        case pageSize
        case authExpire
        case publishDomain
    ...
    public override func encode(to encoder: Encoder) throws {
        var encoderContainer = encoder.container(keyedBy: DescribeLiveRecordFilesRequestRequestCodingKeys.self)
