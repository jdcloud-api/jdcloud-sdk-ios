...
///  导出带宽数据
      ...
      ///       /// 
@objc(ExportLiveStreamBandwidthDataRequest)
public class ExportLiveStreamBandwidthDataRequest:JdCloudRequest
{
    ...
    enum ExportLiveStreamBandwidthDataRequestRequestCodingKeys: String, CodingKey {
        case domainName
        case appName
        case streamName
        case ispName
    ...
    public override func encode(to encoder: Encoder) throws {
        var encoderContainer = encoder.container(keyedBy: ExportLiveStreamBandwidthDataRequestRequestCodingKeys.self)
