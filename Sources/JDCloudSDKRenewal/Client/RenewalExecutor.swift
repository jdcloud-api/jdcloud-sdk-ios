...
public class SetRenewalExecutor:JDCloudExecutor {
    ...
    public init(jdCloudClient: JDCloudClient) {
        super.init(jdCloudClient: jdCloudClient, method: "PUT", url: "/regions/{regionId}/instances:autoRenewStatus")
    }
    
}
///  提供可续费的实例信息查询。
public class QueryInstanceExecutor:JDCloudExecutor {
...
public class RenewInstanceExecutor:JDCloudExecutor {
    ...
    public init(jdCloudClient: JDCloudClient) {
        super.init(jdCloudClient: jdCloudClient, method: "POST", url: "/regions/{regionId}/instances:renew")
    }
