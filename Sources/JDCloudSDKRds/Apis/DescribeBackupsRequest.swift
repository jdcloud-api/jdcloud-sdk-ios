...
public class DescribeBackupsRequest:JdCloudRequest
{
    ...
    public override func encode(to encoder: Encoder) throws {
        ...
        try container.encode(backupTypeFilter, forKey: .backupTypeFilter)
        try container.encode(dbNameFilter, forKey: .dbNameFilter)
        try container.encode(backupTimeRangeStartFilter, forKey: .backupTimeRangeStartFilter)
        try container.encode(backupTimeRangeEndFilter, forKey: .backupTimeRangeEndFilter)
