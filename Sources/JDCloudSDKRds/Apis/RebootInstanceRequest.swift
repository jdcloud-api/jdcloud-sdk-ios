...
public class RebootInstanceRequest:JdCloudRequest
{
    ...
    public override func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: RebootInstanceRequestRequestCodingKeys.self)
        try container.encode(rebootMaster, forKey: .rebootMaster)
        try container.encode(rebootSlave, forKey: .rebootSlave)
