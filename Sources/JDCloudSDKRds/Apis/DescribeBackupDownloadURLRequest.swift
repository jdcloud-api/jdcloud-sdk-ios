...
public class DescribeBackupDownloadURLRequest:JdCloudRequest
{
    ...
    public override func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: DescribeBackupDownloadURLRequestRequestCodingKeys.self)
        try container.encode(fileName, forKey: .fileName)
        try container.encode(urlExpirationSecond, forKey: .urlExpirationSecond)
