...
///  查看回滚配置版本详情
public class DescribeRollbackAppConfigVersionRequest:JdCloudRequest
{
    /// 要查看回滚信息的 当前版本的版本 id
    ...
    enum DescribeRollbackAppConfigVersionRequestRequestCodingKeys: String, CodingKey {
        case appConfigPublishVersionId
    }

    public override func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: DescribeRollbackAppConfigVersionRequestRequestCodingKeys.self)
