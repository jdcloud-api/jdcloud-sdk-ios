...
///  获取当前发布版本的详细信息
public class DescribeAppConfigPublishVersionRequest:JdCloudRequest
{
    /// 要查看的配置发布信息id
    ...
    enum DescribeAppConfigPublishVersionRequestRequestCodingKeys: String, CodingKey {
        case appConfigPublishVersionId
    }

    public override func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: DescribeAppConfigPublishVersionRequestRequestCodingKeys.self)
