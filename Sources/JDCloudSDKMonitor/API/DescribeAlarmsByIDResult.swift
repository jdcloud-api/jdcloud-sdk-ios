...
/// 查询规则详情
@objc(DescribeAlarmsByIDResult)
public class DescribeAlarmsByIDResult:NSObject,JdCloudResult
{
    /// Alarm
    var alarm:Alarm?
    ...
    enum DescribeAlarmsByIDResultCodingKeys: String, CodingKey {
        case alarm
    }
...
public extension DescribeAlarmsByIDResult{
    public func encode(to encoder: Encoder) throws {
        var encoderContainer = encoder.container(keyedBy: DescribeAlarmsByIDResultCodingKeys.self)
