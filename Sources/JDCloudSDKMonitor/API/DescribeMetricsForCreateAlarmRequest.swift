...
@objc(DescribeMetricsForCreateAlarmRequest)
public class DescribeMetricsForCreateAlarmRequest:JdCloudRequest
{
    ...
    enum DescribeMetricsForCreateAlarmRequestRequestCodingKeys: String, CodingKey {
        case serviceCode
    }

    public override func encode(to encoder: Encoder) throws {
        var encoderContainer = encoder.container(keyedBy: DescribeMetricsForCreateAlarmRequestRequestCodingKeys.self)
