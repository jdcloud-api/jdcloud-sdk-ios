...
///  查询规则详情
@objc(DescribeAlarmsByIDRequest)
public class DescribeAlarmsByIDRequest:JdCloudRequest
{
    ...
    enum DescribeAlarmsByIDRequestRequestCodingKeys: String, CodingKey {
        case alarmId
    }

    public override func encode(to encoder: Encoder) throws {
        var encoderContainer = encoder.container(keyedBy: DescribeAlarmsByIDRequestRequestCodingKeys.self)
