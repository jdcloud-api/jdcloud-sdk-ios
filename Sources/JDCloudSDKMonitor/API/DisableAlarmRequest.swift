...
public class DisableAlarmRequest:JdCloudRequest
{
    ...
    enum DisableAlarmRequestRequestCodingKeys: String, CodingKey {
        case alarmId
    }

    public override func encode(to encoder: Encoder) throws {
        var encoderContainer = encoder.container(keyedBy: DisableAlarmRequestRequestCodingKeys.self)
