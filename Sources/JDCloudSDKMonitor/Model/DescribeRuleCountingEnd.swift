...
@objc(DescribeRuleCountingEnd)
public class DescribeRuleCountingEnd:NSObject,Codable{
    ...
    enum DescribeRuleCountingEndCodingKeys: String, CodingKey {
        case alarmRuleCount
        case disableRuleCount
        case normalRuleCount
        case serviceCode
        case subUserPermission
        case totalRuleCount
...
public extension DescribeRuleCountingEnd{
    public func encode(to encoder: Encoder) throws {
        var encoderContainer = encoder.container(keyedBy: DescribeRuleCountingEndCodingKeys.self)
         ...
         try encoderContainer.encode(subUserPermission, forKey: .subUserPermission)
