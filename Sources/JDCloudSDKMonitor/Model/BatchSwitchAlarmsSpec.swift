...
@objc(BatchSwitchAlarmsSpec)
public class BatchSwitchAlarmsSpec:NSObject,Codable{
    /// 告警规则的ID列表
    /// Required:true
    var ids:[String?]
    ...
    enum BatchSwitchAlarmsSpecCodingKeys: String, CodingKey {
        case ids
    }


    required public init(from decoder: Decoder) throws {
        let decoderContainer = try decoder.container(keyedBy: BatchSwitchAlarmsSpecCodingKeys.self)
