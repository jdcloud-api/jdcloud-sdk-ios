...
public class DescribeAlarmHistoryCmRequest:JdCloudRequest
{
    ...
    enum DescribeAlarmHistoryCmRequestRequestCodingKeys: String, CodingKey {
        case pageNumber
        case pageSize
        case id
        case obi
    ...
    public override func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: DescribeAlarmHistoryCmRequestRequestCodingKeys.self)
