...
public class UpdateProbeTaskRequest:JdCloudRequest
{
    ...
    public override func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: UpdateProbeTaskRequestRequestCodingKeys.self)
        try container.encode(address, forKey: .address)
        try container.encode(frequency, forKey: .frequency)
        try container.encode(httpBody, forKey: .httpBody)
        try container.encode(httpCookie, forKey: .httpCookie)
        try container.encode(httpHeader, forKey: .httpHeader)
        try container.encode(name, forKey: .name)
        try container.encode(port, forKey: .port)
        try container.encode(probes, forKey: .probes)
        try container.encode(targetId, forKey: .targetId)
        try container.encode(targetRegion, forKey: .targetRegion)
