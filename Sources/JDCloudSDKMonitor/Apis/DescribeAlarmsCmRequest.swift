...
///  查询自定义监控规则
public class DescribeAlarmsCmRequest:JdCloudRequest
{
    /// 当前所在页，默认为1
    ...
    enum DescribeAlarmsCmRequestRequestCodingKeys: String, CodingKey {
        case pageNumber
        case pageSize
        case namespace
        case obj
    ...
    public override func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: DescribeAlarmsCmRequestRequestCodingKeys.self)
