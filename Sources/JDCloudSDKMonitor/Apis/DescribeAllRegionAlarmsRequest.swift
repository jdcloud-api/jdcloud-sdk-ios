...
///  查询规则, 查询参数组合及优先级从高到低为：
        ...
        ///         /// 2：serviceCodes不为空
        ///         /// 3: 所有规则
public class DescribeAllRegionAlarmsRequest:JdCloudRequest
{
    /// 当前所在页，默认为1
    ...
    enum DescribeAllRegionAlarmsRequestRequestCodingKeys: String, CodingKey {
        case pageNumber
        case pageSize
        case serviceCode
        case resourceID
    ...
    public override func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: DescribeAllRegionAlarmsRequestRequestCodingKeys.self)
