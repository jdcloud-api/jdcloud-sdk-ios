...
public class SetNotificationRequest:JdCloudRequest
{
    ...
    public override func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: SetNotificationRequestRequestCodingKeys.self)
        try container.encode(enabled, forKey: .enabled)
        try container.encode(endpoint, forKey: .endpoint)
        try container.encode(events, forKey: .events)
        try container.encode(notifyStrategy, forKey: .notifyStrategy)
        try container.encode(notifyContentFormat, forKey: .notifyContentFormat)
