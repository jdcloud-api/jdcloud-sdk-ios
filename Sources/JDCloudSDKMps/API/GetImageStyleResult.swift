...
/// 图片样式详情
@objc(GetImageStyleResult)
public class GetImageStyleResult:NSObject,JdCloudResult
{
    /// 图片样式id(readOnly)
    var id:Int64?
    ...
    enum GetImageStyleResultCodingKeys: String, CodingKey {
        case id
        case userId
        case styleName
        case params
    ...
    required public init(from decoder: Decoder) throws {
        let decoderContainer = try decoder.container(keyedBy: GetImageStyleResultCodingKeys.self)
...
public extension GetImageStyleResult{
    func encode(to encoder: Encoder) throws {
        var encoderContainer = encoder.container(keyedBy: GetImageStyleResultCodingKeys.self)
