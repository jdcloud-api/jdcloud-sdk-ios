...
///  导出我的客户信息
public class ExportMyCustomerListRequest:JdCloudRequest
{
    /// 客户pin（客户账户）
    ...
    enum ExportMyCustomerListRequestRequestCodingKeys: String, CodingKey {
        case customerPin
        case aliasName
        case startRelTime
        case endRelTime
    ...
    public override func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: ExportMyCustomerListRequestRequestCodingKeys.self)
