...
///  修改二级渠道商
public class ModifyTwoLevelDistributorInfoRequest:JdCloudRequest
{
    /// 渠道商ID
    ...
    enum ModifyTwoLevelDistributorInfoRequestRequestCodingKeys: String, CodingKey {
        case distributorId
    ...
    public override func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: ModifyTwoLevelDistributorInfoRequestRequestCodingKeys.self)
