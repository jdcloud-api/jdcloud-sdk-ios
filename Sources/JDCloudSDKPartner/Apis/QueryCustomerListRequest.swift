...
///  运营后台查询客户信息
public class QueryCustomerListRequest:JdCloudRequest
{
    /// 客户pin（客户账户）
    ...
    enum QueryCustomerListRequestRequestCodingKeys: String, CodingKey {
        case customerPin
        case aliasName
    ...
    public override func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: QueryCustomerListRequestRequestCodingKeys.self)
