...
///  运营人员查询渠道商列表导出
public class ExportDistributorListForErpRequest:JdCloudRequest
{
    /// 渠道商ID
    ...
    enum ExportDistributorListForErpRequestRequestCodingKeys: String, CodingKey {
        case distributorId
    ...
    public override func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: ExportDistributorListForErpRequestRequestCodingKeys.self)
