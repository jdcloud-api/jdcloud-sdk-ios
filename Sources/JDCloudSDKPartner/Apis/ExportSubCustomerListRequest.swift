...
///  导出下级服务商客户列表
public class ExportSubCustomerListRequest:JdCloudRequest
{
    /// 渠道商名称
    ...
    enum ExportSubCustomerListRequestRequestCodingKeys: String, CodingKey {
    ...
    public override func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: ExportSubCustomerListRequestRequestCodingKeys.self)
