...
///  查询下级渠道商列表导出
public class ExportSubDistributorListRequest:JdCloudRequest
{
    /// 渠道商ID
    ...
    enum ExportSubDistributorListRequestRequestCodingKeys: String, CodingKey {
        case distributorId
    ...
    public override func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: ExportSubDistributorListRequestRequestCodingKeys.self)
