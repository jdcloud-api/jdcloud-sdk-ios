...
///  添加一级渠道商
public class AddDistributorLevelOneRequest:JdCloudRequest
{
    /// 渠道商ID
    ...
    enum AddDistributorLevelOneRequestRequestCodingKeys: String, CodingKey {
        case distributorId
    ...
    public override func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: AddDistributorLevelOneRequestRequestCodingKeys.self)
