...
///  运营人员查询渠道商列表
public class GetDistributorListForErpRequest:JdCloudRequest
{
    /// 渠道商ID
    ...
    enum GetDistributorListForErpRequestRequestCodingKeys: String, CodingKey {
        case distributorId
    ...
    public override func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: GetDistributorListForErpRequestRequestCodingKeys.self)
