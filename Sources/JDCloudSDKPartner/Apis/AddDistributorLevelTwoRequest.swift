...
///  添加二级渠道商
public class AddDistributorLevelTwoRequest:JdCloudRequest
{
    /// 渠道商ID
    ...
    enum AddDistributorLevelTwoRequestRequestCodingKeys: String, CodingKey {
        case distributorId
    ...
    public override func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: AddDistributorLevelTwoRequestRequestCodingKeys.self)
