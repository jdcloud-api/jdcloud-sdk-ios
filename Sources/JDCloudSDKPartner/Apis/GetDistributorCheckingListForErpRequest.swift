...
///  查询待审批渠道商列表
public class GetDistributorCheckingListForErpRequest:JdCloudRequest
{
    /// 渠道商ID
    ...
    enum GetDistributorCheckingListForErpRequestRequestCodingKeys: String, CodingKey {
        case distributorId
    ...
    public override func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: GetDistributorCheckingListForErpRequestRequestCodingKeys.self)
        ...
        try container.encode(parentDistributorName, forKey: .parentDistributorName)
        try container.encode(dept, forKey: .dept)
        try container.encode(erp, forKey: .erp)
        try container.encode(settleTimeBegin, forKey: .settleTimeBegin)
        try container.encode(settleTimeEnd, forKey: .settleTimeEnd)
