...
///  查询渠道商信息
public class QueryDistributorInfoRequest:JdCloudRequest
{
    /// 渠道商ID
    ...
    enum QueryDistributorInfoRequestRequestCodingKeys: String, CodingKey {
        case distributorId
    ...
    public override func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: QueryDistributorInfoRequestRequestCodingKeys.self)
