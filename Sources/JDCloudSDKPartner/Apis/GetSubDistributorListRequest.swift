...
///  查询下级渠道商列表
public class GetSubDistributorListRequest:JdCloudRequest
{
    /// 渠道商ID
    ...
    enum GetSubDistributorListRequestRequestCodingKeys: String, CodingKey {
        case distributorId
    ...
    public override func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: GetSubDistributorListRequestRequestCodingKeys.self)
