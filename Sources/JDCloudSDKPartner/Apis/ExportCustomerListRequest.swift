...
///  运营后台导出客户信息
public class ExportCustomerListRequest:JdCloudRequest
{
    /// 客户pin（客户账户）
    ...
    enum ExportCustomerListRequestRequestCodingKeys: String, CodingKey {
        case customerPin
        case aliasName
    ...
    public override func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: ExportCustomerListRequestRequestCodingKeys.self)
