...
///  修改一级渠道商
public class ModifyOneLevelDistributorInfoRequest:JdCloudRequest
{
    /// 渠道商ID
    ...
    enum ModifyOneLevelDistributorInfoRequestRequestCodingKeys: String, CodingKey {
        case distributorId
    ...
    public override func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: ModifyOneLevelDistributorInfoRequestRequestCodingKeys.self)
