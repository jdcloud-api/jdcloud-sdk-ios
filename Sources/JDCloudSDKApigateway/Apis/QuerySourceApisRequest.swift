...
public class QuerySourceApisRequest:JdCloudRequest
{
    /// 分组ID
    ...
    enum QuerySourceApisRequestRequestCodingKeys: String, CodingKey {
        case apiGroupId
        case revision
        case apiId
    }
    ...
    public override func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: QuerySourceApisRequestRequestCodingKeys.self)
