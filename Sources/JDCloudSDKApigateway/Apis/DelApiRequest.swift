...
///  删除api
public class DelApiRequest:JdCloudRequest
{
    /// 分组ID
    ...
    enum DelApiRequestRequestCodingKeys: String, CodingKey {
        case apiGroupId
        case revision
        case apiId
    }
    ...
    public override func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: DelApiRequestRequestCodingKeys.self)
