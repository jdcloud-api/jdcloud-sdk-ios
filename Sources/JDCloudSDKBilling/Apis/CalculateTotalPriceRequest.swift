...
public class CalculateTotalPriceRequest:JdCloudRequest
{
    ...
    public override func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: CalculateTotalPriceRequestRequestCodingKeys.self)
        try container.encode(cmd, forKey: .cmd)
        try container.encode(orderList, forKey: .orderList)
        try container.encode(operateTime, forKey: .operateTime)
        try container.encode(promotionInfo, forKey: .promotionInfo)
