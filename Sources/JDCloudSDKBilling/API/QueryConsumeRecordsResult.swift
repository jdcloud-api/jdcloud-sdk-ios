...
/// 查询资源账单详情
@objc(QueryConsumeRecordsResult)
public class QueryConsumeRecordsResult:NSObject,JdCloudResult
{
    /// Pagination
    ...
    enum QueryConsumeRecordsResultCodingKeys: String, CodingKey {
        case pagination
        case result
    }
...
public extension QueryConsumeRecordsResult{
    public func encode(to encoder: Encoder) throws {
        var encoderContainer = encoder.container(keyedBy: QueryConsumeRecordsResultCodingKeys.self)
