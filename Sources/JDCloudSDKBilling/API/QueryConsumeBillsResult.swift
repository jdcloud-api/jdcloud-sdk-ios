...
/// 查询消费记录列表
@objc(QueryConsumeBillsResult)
public class QueryConsumeBillsResult:NSObject,JdCloudResult
{
    /// Pagination
    ...
    enum QueryConsumeBillsResultCodingKeys: String, CodingKey {
        case pagination
        case result
    }
...
public extension QueryConsumeBillsResult{
    public func encode(to encoder: Encoder) throws {
        var encoderContainer = encoder.container(keyedBy: QueryConsumeBillsResultCodingKeys.self)
