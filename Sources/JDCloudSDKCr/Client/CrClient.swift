...
public class CrJDCloudClient :JDCloudClient{
    ...
    public func modifyQuotaAsync(request:ModifyQuotaRequest,requestComplation:@escaping ExecuteResult<ModifyQuotaResult>) throws {
        crJDCloudClient = self
        try ModifyQuotaExecutor(jdCloudClient: crJDCloudClient).executeAsync(request: request){(statusCode,result, error,data) in
             requestComplation(statusCode,result,error,data)
        }
    } 
