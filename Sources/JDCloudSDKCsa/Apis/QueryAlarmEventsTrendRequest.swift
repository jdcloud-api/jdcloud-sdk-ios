...
///  查询告警事件数对比
public class QueryAlarmEventsTrendRequest:JdCloudRequest
{
    ...
    enum QueryAlarmEventsTrendRequestRequestCodingKeys: String, CodingKey {
        case timeBegin
        case timeEnd
        case timeSpan
        case severities
    ...
    public override func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: QueryAlarmEventsTrendRequestRequestCodingKeys.self)
