...
///  查询威胁事件安全事件统计接口
public class QueryThreatEventsNameCountStatRequest:JdCloudRequest
{
    ...
    enum QueryThreatEventsNameCountStatRequestRequestCodingKeys: String, CodingKey {
        case timeBegin
        case timeEnd
        case timeSpan
        case threatModel
    ...
    public override func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: QueryThreatEventsNameCountStatRequestRequestCodingKeys.self)
