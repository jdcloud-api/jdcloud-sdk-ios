...
///  查询安全事件发展趋势
public class QueryStatisticsEventTrendRequest:JdCloudRequest
{
    ...
    enum QueryStatisticsEventTrendRequestRequestCodingKeys: String, CodingKey {
        case timeBegin
        case timeEnd
        case timeSpan
        case severities
    ...
    public override func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: QueryStatisticsEventTrendRequestRequestCodingKeys.self)
