...
///  查询定向攻击事件列表接口
public class QueryTargetAttacksRequest:JdCloudRequest
{
    /// 页码；默认为1
    var pageNumber:Int?
    ...
    enum QueryTargetAttacksRequestRequestCodingKeys: String, CodingKey {
        case pageNumber
        case pageSize
        case timeBegin
        case timeEnd
    ...
    public override func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: QueryTargetAttacksRequestRequestCodingKeys.self)
