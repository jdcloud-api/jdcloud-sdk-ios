...
///  查询专用Web漏洞记录数对比
public class QueryWebsiteVulsTrendRequest:JdCloudRequest
{
    ...
    enum QueryWebsiteVulsTrendRequestRequestCodingKeys: String, CodingKey {
        case timeBegin
        case timeEnd
        case timeSpan
        case severities
    ...
    public override func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: QueryWebsiteVulsTrendRequestRequestCodingKeys.self)
