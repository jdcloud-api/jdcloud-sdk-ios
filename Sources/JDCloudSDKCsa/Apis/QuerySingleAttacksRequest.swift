...
public class QuerySingleAttacksRequest:JdCloudRequest
{
    ...
    enum QuerySingleAttacksRequestRequestCodingKeys: String, CodingKey {
        case pageNumber
        case pageSize
        case timeBegin
        case timeEnd
    ...
    public override func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: QuerySingleAttacksRequestRequestCodingKeys.self)
