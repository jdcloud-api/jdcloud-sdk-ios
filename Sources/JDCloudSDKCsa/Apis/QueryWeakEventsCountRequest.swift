...
public class QueryWeakEventsCountRequest:JdCloudRequest
{
    ...
    enum QueryWeakEventsCountRequestRequestCodingKeys: String, CodingKey {
        case timeBegin
        case timeEnd
        case timeSpan
        case severities
    ...
    public override func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: QueryWeakEventsCountRequestRequestCodingKeys.self)
