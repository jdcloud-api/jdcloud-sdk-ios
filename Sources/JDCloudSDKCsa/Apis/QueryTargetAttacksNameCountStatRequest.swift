...
public class QueryTargetAttacksNameCountStatRequest:JdCloudRequest
{
    ...
    enum QueryTargetAttacksNameCountStatRequestRequestCodingKeys: String, CodingKey {
        case timeBegin
        case timeEnd
        case timeSpan
        case threatModel
    ...
    public override func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: QueryTargetAttacksNameCountStatRequestRequestCodingKeys.self)
