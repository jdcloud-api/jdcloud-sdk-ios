...
///  查询威胁事件数对比
public class QueryThreatEventsTrendRequest:JdCloudRequest
{
    ...
    enum QueryThreatEventsTrendRequestRequestCodingKeys: String, CodingKey {
        case timeBegin
        case timeEnd
        case timeSpan
        case severities
    ...
    public override func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: QueryThreatEventsTrendRequestRequestCodingKeys.self)
