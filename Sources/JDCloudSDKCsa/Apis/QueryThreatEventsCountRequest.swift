...
///  查询威胁事件数
public class QueryThreatEventsCountRequest:JdCloudRequest
{
    ...
    enum QueryThreatEventsCountRequestRequestCodingKeys: String, CodingKey {
        case timeBegin
        case timeEnd
        case timeSpan
        case severities
    ...
    public override func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: QueryThreatEventsCountRequestRequestCodingKeys.self)
