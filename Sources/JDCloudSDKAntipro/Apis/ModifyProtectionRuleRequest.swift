...
public class ModifyProtectionRuleRequest:JdCloudRequest
{
    ...
    public override func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: ModifyProtectionRuleRequestRequestCodingKeys.self)
        try container.encode(protectionRuleSpec, forKey: .protectionRuleSpec)
