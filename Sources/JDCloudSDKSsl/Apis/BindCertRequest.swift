...
///  关联证书
public class BindCertRequest:JdCloudRequest
{
    /// 绑定来源
    var bindFrom:String
    ...
    enum BindCertRequestRequestCodingKeys: String, CodingKey {
        case bindFrom
        case bindId
        case certId
    }
    ...
    public override func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: BindCertRequestRequestCodingKeys.self)
