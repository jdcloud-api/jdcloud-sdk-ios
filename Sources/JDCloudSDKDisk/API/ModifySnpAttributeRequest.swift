...
///  修改快照的名字或描述信息
@objc(ModifySnpAttributeRequest)
public class ModifySnpAttributeRequest:JdCloudRequest
{
    ...
    enum ModifySnpAttributeRequestRequestCodingKeys: String, CodingKey {
        case name
    ...
    public override func encode(to encoder: Encoder) throws {
        var encoderContainer = encoder.container(keyedBy: ModifySnpAttributeRequestRequestCodingKeys.self)
