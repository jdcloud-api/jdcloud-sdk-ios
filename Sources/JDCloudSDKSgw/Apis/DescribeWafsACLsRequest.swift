...
///  查询攻击信息-自定义访问控制规则日志
public class DescribeWafsACLsRequest:JdCloudRequest
{
    ...
    enum DescribeWafsACLsRequestRequestCodingKeys: String, CodingKey {
        case pageSize
        case pageNumber
        case timespan
        case timeunit
    ...
    public override func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: DescribeWafsACLsRequestRequestCodingKeys.self)
