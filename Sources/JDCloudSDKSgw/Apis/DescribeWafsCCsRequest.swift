...
///  查询攻击信息-CC攻击日志
public class DescribeWafsCCsRequest:JdCloudRequest
{
    ...
    enum DescribeWafsCCsRequestRequestCodingKeys: String, CodingKey {
        case pageSize
        case pageNumber
        case timespan
        case timeunit
    ...
    public override func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: DescribeWafsCCsRequestRequestCodingKeys.self)
