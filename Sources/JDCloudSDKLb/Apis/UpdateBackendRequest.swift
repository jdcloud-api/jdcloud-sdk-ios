...
public class UpdateBackendRequest:JdCloudRequest
{
    ...
    var closeHealthCheck:Bool?

    /// Backend Id
    var backendId:String


    public init(regionId: String,backendId:String){
        self.backendId = backendId
        super.init(regionId: regionId)
    }


    enum UpdateBackendRequestRequestCodingKeys: String, CodingKey {
        case backendName
    ...
    public override func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: UpdateBackendRequestRequestCodingKeys.self)
        ...
        try container.encode(closeHealthCheck, forKey: .closeHealthCheck)
