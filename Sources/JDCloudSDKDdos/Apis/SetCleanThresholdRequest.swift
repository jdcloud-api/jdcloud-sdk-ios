...
public class SetCleanThresholdRequest:JdCloudRequest
{
    ...
    public override func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: SetCleanThresholdRequestRequestCodingKeys.self)
        try container.encode(cleanThresholdSpec, forKey: .cleanThresholdSpec)
