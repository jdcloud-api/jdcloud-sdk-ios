...
public class BaseantiJDCloudClient :JDCloudClient{
    ...
    public func describCpsIpResourcesAsync(request:DescribCpsIpResourcesRequest,requestComplation:@escaping ExecuteResult<DescribCpsIpResourcesResult>) throws {
        baseantiJDCloudClient = self
        try DescribCpsIpResourcesExecutor(jdCloudClient: baseantiJDCloudClient).executeAsync(request: request){(statusCode,result, error,data) in
             requestComplation(statusCode,result,error,data)
        }
    } 
    ...
    public func describeAttackLogAsync(request:DescribeAttackLogRequest,requestComplation:@escaping ExecuteResult<DescribeAttackLogResult>) throws {
        baseantiJDCloudClient = self
        try DescribeAttackLogExecutor(jdCloudClient: baseantiJDCloudClient).executeAsync(request: request){(statusCode,result, error,data) in
             requestComplation(statusCode,result,error,data)
        }
    } 
