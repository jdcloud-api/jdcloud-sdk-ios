...
public class MonitorcmJDCloudClient :JDCloudClient{
    
    private final var monitorcmJDCloudClient:MonitorcmJDCloudClient!
    ...
    public let userAgent: String = "JdcloudSdkSwift" + "0.0.1" + "monitorcm" + "v1"
    
    public let serviceName: String = "monitorcm"
    ...
    public func putMetricDataAsync(request:PutMetricDataRequest,requestComplation:@escaping ExecuteResult<PutMetricDataResult>) throws {
        monitorcmJDCloudClient = self
        try PutMetricDataExecutor(jdCloudClient: monitorcmJDCloudClient).executeAsync(request: request){(statusCode,result, error,data) in
...
public extension MonitorcmJDCloudClient{
