...
public class ClouddnsserviceJDCloudClient :JDCloudClient{
    ...
    public func getPriceAsync(request:GetPriceRequest,requestComplation:@escaping ExecuteResult<GetPriceResult>) throws {
        clouddnsserviceJDCloudClient = self
        try GetPriceExecutor(jdCloudClient: clouddnsserviceJDCloudClient).executeAsync(request: request){(statusCode,result, error,data) in
             requestComplation(statusCode,result,error,data)
        }
    } 
    public func getDomainsInternalAsync(request:GetDomainsInternalRequest,requestComplation:@escaping ExecuteResult<GetDomainsInternalResult>) throws {
        clouddnsserviceJDCloudClient = self
        try GetDomainsInternalExecutor(jdCloudClient: clouddnsserviceJDCloudClient).executeAsync(request: request){(statusCode,result, error,data) in
             requestComplation(statusCode,result,error,data)
        }
    } 
    public func getWhoisAsync(request:GetWhoisRequest,requestComplation:@escaping ExecuteResult<GetWhoisResult>) throws {
        clouddnsserviceJDCloudClient = self
        try GetWhoisExecutor(jdCloudClient: clouddnsserviceJDCloudClient).executeAsync(request: request){(statusCode,result, error,data) in
             requestComplation(statusCode,result,error,data)
        }
    } 
    ...
    public func newOrderAsync(request:NewOrderRequest,requestComplation:@escaping ExecuteResult<NewOrderResult>) throws {
        clouddnsserviceJDCloudClient = self
        try NewOrderExecutor(jdCloudClient: clouddnsserviceJDCloudClient).executeAsync(request: request){(statusCode,result, error,data) in
             requestComplation(statusCode,result,error,data)
        }
    } 
    ...
    public func getHttpInfoAsync(request:GetHttpInfoRequest,requestComplation:@escaping ExecuteResult<GetHttpInfoResult>) throws {
        clouddnsserviceJDCloudClient = self
        try GetHttpInfoExecutor(jdCloudClient: clouddnsserviceJDCloudClient).executeAsync(request: request){(statusCode,result, error,data) in
             requestComplation(statusCode,result,error,data)
        }
    } 
    public func getALBAsync(request:GetALBRequest,requestComplation:@escaping ExecuteResult<GetALBResult>) throws {
        clouddnsserviceJDCloudClient = self
        try GetALBExecutor(jdCloudClient: clouddnsserviceJDCloudClient).executeAsync(request: request){(statusCode,result, error,data) in
             requestComplation(statusCode,result,error,data)
        }
    } 
    ...
    public func setALBAsync(request:SetALBRequest,requestComplation:@escaping ExecuteResult<SetALBResult>) throws {
        clouddnsserviceJDCloudClient = self
        try SetALBExecutor(jdCloudClient: clouddnsserviceJDCloudClient).executeAsync(request: request){(statusCode,result, error,data) in
             requestComplation(statusCode,result,error,data)
        }
    } 
    public func getRecordAsync(request:GetRecordRequest,requestComplation:@escaping ExecuteResult<GetRecordResult>) throws {
        clouddnsserviceJDCloudClient = self
        try GetRecordExecutor(jdCloudClient: clouddnsserviceJDCloudClient).executeAsync(request: request){(statusCode,result, error,data) in
             requestComplation(statusCode,result,error,data)
        }
    } 
    ...
    public func getRRInfoAsync(request:GetRRInfoRequest,requestComplation:@escaping ExecuteResult<GetRRInfoResult>) throws {
        clouddnsserviceJDCloudClient = self
        try GetRRInfoExecutor(jdCloudClient: clouddnsserviceJDCloudClient).executeAsync(request: request){(statusCode,result, error,data) in
             requestComplation(statusCode,result,error,data)
        }
    } 
    ...
    public func checkDomainAsync(request:CheckDomainRequest,requestComplation:@escaping ExecuteResult<CheckDomainResult>) throws {
        clouddnsserviceJDCloudClient = self
        try CheckDomainExecutor(jdCloudClient: clouddnsserviceJDCloudClient).executeAsync(request: request){(statusCode,result, error,data) in
             requestComplation(statusCode,result,error,data)
        }
    } 
    ...
    public func importDnsResolveAsync(request:ImportDnsResolveRequest,requestComplation:@escaping ExecuteResult<ImportDnsResolveResult>) throws {
        clouddnsserviceJDCloudClient = self
        try ImportDnsResolveExecutor(jdCloudClient: clouddnsserviceJDCloudClient).executeAsync(request: request){(statusCode,result, error,data) in
             requestComplation(statusCode,result,error,data)
        }
    } 
    ...
    public func getDigTraceAsync(request:GetDigTraceRequest,requestComplation:@escaping ExecuteResult<GetDigTraceResult>) throws {
        clouddnsserviceJDCloudClient = self
        try GetDigTraceExecutor(jdCloudClient: clouddnsserviceJDCloudClient).executeAsync(request: request){(statusCode,result, error,data) in
             requestComplation(statusCode,result,error,data)
        }
    } 
    public func getAllNoticeItemAsync(request:GetAllNoticeItemRequest,requestComplation:@escaping ExecuteResult<GetAllNoticeItemResult>) throws {
        clouddnsserviceJDCloudClient = self
        try GetAllNoticeItemExecutor(jdCloudClient: clouddnsserviceJDCloudClient).executeAsync(request: request){(statusCode,result, error,data) in
             requestComplation(statusCode,result,error,data)
        }
    } 
    ...
    public func getVpcIpAsync(request:GetVpcIpRequest,requestComplation:@escaping ExecuteResult<GetVpcIpResult>) throws {
        clouddnsserviceJDCloudClient = self
        try GetVpcIpExecutor(jdCloudClient: clouddnsserviceJDCloudClient).executeAsync(request: request){(statusCode,result, error,data) in
             requestComplation(statusCode,result,error,data)
        }
    } 
    ...
    public func getSubDomainsAsync(request:GetSubDomainsRequest,requestComplation:@escaping ExecuteResult<GetSubDomainsResult>) throws {
        clouddnsserviceJDCloudClient = self
        try GetSubDomainsExecutor(jdCloudClient: clouddnsserviceJDCloudClient).executeAsync(request: request){(statusCode,result, error,data) in
             requestComplation(statusCode,result,error,data)
        }
    } 
    ...
    public func exportDnsResolveAsync(request:ExportDnsResolveRequest,requestComplation:@escaping ExecuteResult<ExportDnsResolveResult>) throws {
        clouddnsserviceJDCloudClient = self
        try ExportDnsResolveExecutor(jdCloudClient: clouddnsserviceJDCloudClient).executeAsync(request: request){(statusCode,result, error,data) in
             requestComplation(statusCode,result,error,data)
        }
    } 
