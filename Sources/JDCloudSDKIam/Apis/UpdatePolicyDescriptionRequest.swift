...
public class UpdatePolicyDescriptionRequest:JdCloudRequest
{
    ...
    public override func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: UpdatePolicyDescriptionRequestRequestCodingKeys.self)
        try container.encode(updatePolicyDescriptionInfo, forKey: .updatePolicyDescriptionInfo)
