...
public class UpdateAssumeRolePolicyRequest:JdCloudRequest
{
    ...
    public override func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: UpdateAssumeRolePolicyRequestRequestCodingKeys.self)
        try container.encode(updateAssumeRolePolicyInfo, forKey: .updateAssumeRolePolicyInfo)
