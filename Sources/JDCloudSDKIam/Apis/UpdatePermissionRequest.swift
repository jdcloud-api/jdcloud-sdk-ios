...
public class UpdatePermissionRequest:JdCloudRequest
{
    ...
    public override func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: UpdatePermissionRequestRequestCodingKeys.self)
        try container.encode(updatePermissionInfo, forKey: .updatePermissionInfo)
