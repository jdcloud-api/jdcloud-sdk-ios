...
///  客户用该接口可以登记模块
      ///       /// 
@objc(ModuleEnrollmentRequest)
public class ModuleEnrollmentRequest:JdCloudRequest
{
    /// InstanceId
    ...
    enum ModuleEnrollmentRequestRequestCodingKeys: String, CodingKey {
        case instanceId
        case modelName
    ...
    public override func encode(to encoder: Encoder) throws {
        var encoderContainer = encoder.container(keyedBy: ModuleEnrollmentRequestRequestCodingKeys.self)
