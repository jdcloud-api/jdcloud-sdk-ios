...
@objc(UnassociateEipAddressReq)
public class UnassociateEipAddressReq:NSObject,Codable{
    /// Unassociate
    ...
    enum UnassociateEipAddressReqCodingKeys: String, CodingKey {
        case unassociate
    }
...
public extension UnassociateEipAddressReq{
    public func encode(to encoder: Encoder) throws {
        var encoderContainer = encoder.container(keyedBy: UnassociateEipAddressReqCodingKeys.self)
