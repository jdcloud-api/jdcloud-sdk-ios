...
///  createSubnetReq
@objc(CreateSubnetReq)
public class CreateSubnetReq:NSObject,Codable{
    /// Subnet
    ...
    enum CreateSubnetReqCodingKeys: String, CodingKey {
        case subnet
    }
...
public extension CreateSubnetReq{
    public func encode(to encoder: Encoder) throws {
        var encoderContainer = encoder.container(keyedBy: CreateSubnetReqCodingKeys.self)
