...
///  createVmReq
@objc(CreateVmReq)
public class CreateVmReq:NSObject,Codable{
    /// Vms
    var vms:CreateVm?
    ...
    enum CreateVmReqCodingKeys: String, CodingKey {
        case vms
    }
...
public extension CreateVmReq{
    public func encode(to encoder: Encoder) throws {
        var encoderContainer = encoder.container(keyedBy: CreateVmReqCodingKeys.self)
