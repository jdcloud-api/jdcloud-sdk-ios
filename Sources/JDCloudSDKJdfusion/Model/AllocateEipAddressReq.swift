...
@objc(AllocateEipAddressReq)
public class AllocateEipAddressReq:NSObject,Codable{
    /// Allocate
    ...
    enum AllocateEipAddressReqCodingKeys: String, CodingKey {
        case allocate
    }
...
public extension AllocateEipAddressReq{
    public func encode(to encoder: Encoder) throws {
        var encoderContainer = encoder.container(keyedBy: AllocateEipAddressReqCodingKeys.self)
