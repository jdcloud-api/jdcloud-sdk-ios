...
///  attachDataDiskReq
@objc(AttachDataDiskReq)
public class AttachDataDiskReq:NSObject,Codable{
    /// Attach
    ...
    enum AttachDataDiskReqCodingKeys: String, CodingKey {
        case attach
    }
...
public extension AttachDataDiskReq{
    public func encode(to encoder: Encoder) throws {
        var encoderContainer = encoder.container(keyedBy: AttachDataDiskReqCodingKeys.self)
