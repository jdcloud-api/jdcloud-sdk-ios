...
///  createDataDiskReq
@objc(CreateDataDiskReq)
public class CreateDataDiskReq:NSObject,Codable{
    /// Disk
    ...
    enum CreateDataDiskReqCodingKeys: String, CodingKey {
        case disk
    }
...
public extension CreateDataDiskReq{
    public func encode(to encoder: Encoder) throws {
        var encoderContainer = encoder.container(keyedBy: CreateDataDiskReqCodingKeys.self)
