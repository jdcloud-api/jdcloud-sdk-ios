...
@objc(CreateVserverGroupReq)
public class CreateVserverGroupReq:NSObject,Codable{
    /// VserverGroup
    ...
    enum CreateVserverGroupReqCodingKeys: String, CodingKey {
        case vserverGroup
    }
...
public extension CreateVserverGroupReq{
    public func encode(to encoder: Encoder) throws {
        var encoderContainer = encoder.container(keyedBy: CreateVserverGroupReqCodingKeys.self)
