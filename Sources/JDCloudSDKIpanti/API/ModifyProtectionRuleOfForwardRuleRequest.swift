...
///  修改非网站类转发规则的防护规则
@objc(ModifyProtectionRuleOfForwardRuleRequest)
public class ModifyProtectionRuleOfForwardRuleRequest:JdCloudRequest
{
    ...
    public init(regionId: String,forwardProtectionRuleSpec:ForwardProtectionRuleSpec,instanceId:Int64,forwardRuleId:Int64){
