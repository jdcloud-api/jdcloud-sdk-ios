...
{
    /// 变更后的缓存Redis规格，详细参见：&lt;a href&#x3D;&quot;https://docs.jdcloud.com/cn/jcs-for-redis/specifications&quot;&gt;实例规格代码&lt;/a&gt;
    ...
    public override func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: ModifyCacheInstanceClassRequestRequestCodingKeys.self)
        try container.encode(cacheInstanceClass, forKey: .cacheInstanceClass)
