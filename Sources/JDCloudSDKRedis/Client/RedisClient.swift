...
public class RedisJDCloudClient :JDCloudClient{
    ...
    public func modifyUserQuotaAsync(request:ModifyUserQuotaRequest,requestComplation:@escaping ExecuteResult<ModifyUserQuotaResult>) throws {
        redisJDCloudClient = self
        try ModifyUserQuotaExecutor(jdCloudClient: redisJDCloudClient).executeAsync(request: request){(statusCode,result, error,data) in
    ...
    public func describeOrderStatusAsync(request:DescribeOrderStatusRequest,requestComplation:@escaping ExecuteResult<DescribeOrderStatusResult>) throws {
        redisJDCloudClient = self
        try DescribeOrderStatusExecutor(jdCloudClient: redisJDCloudClient).executeAsync(request: request){(statusCode,result, error,data) in
             requestComplation(statusCode,result,error,data)
        }
    } 
    ...
    public func describeInstanceNamesAsync(request:DescribeInstanceNamesRequest,requestComplation:@escaping ExecuteResult<DescribeInstanceNamesResult>) throws {
        redisJDCloudClient = self
        try DescribeInstanceNamesExecutor(jdCloudClient: redisJDCloudClient).executeAsync(request: request){(statusCode,result, error,data) in
             requestComplation(statusCode,result,error,data)
        }
    } 
    ...
    public func modifyInstanceClassAsync(request:ModifyInstanceClassRequest,requestComplation:@escaping ExecuteResult<ModifyInstanceClassResult>) throws {
        redisJDCloudClient = self
        try ModifyInstanceClassExecutor(jdCloudClient: redisJDCloudClient).executeAsync(request: request){(statusCode,result, error,data) in
             requestComplation(statusCode,result,error,data)
        }
    } 
