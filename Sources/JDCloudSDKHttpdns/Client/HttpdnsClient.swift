...
public class HttpdnsJDCloudClient :JDCloudClient{
    ...
    public func queryCountAsync(request:QueryCountRequest,requestComplation:@escaping ExecuteResult<QueryCountResult>) throws {
        httpdnsJDCloudClient = self
        try QueryCountExecutor(jdCloudClient: httpdnsJDCloudClient).executeAsync(request: request){(statusCode,result, error,data) in
             requestComplation(statusCode,result,error,data)
        }
    } 
    public func queryTotalCountAsync(request:QueryTotalCountRequest,requestComplation:@escaping ExecuteResult<QueryTotalCountResult>) throws {
        httpdnsJDCloudClient = self
        try QueryTotalCountExecutor(jdCloudClient: httpdnsJDCloudClient).executeAsync(request: request){(statusCode,result, error,data) in
             requestComplation(statusCode,result,error,data)
        }
    } 
    public func getDataPlanInfoAsync(request:GetDataPlanInfoRequest,requestComplation:@escaping ExecuteResult<GetDataPlanInfoResult>) throws {
        httpdnsJDCloudClient = self
        try GetDataPlanInfoExecutor(jdCloudClient: httpdnsJDCloudClient).executeAsync(request: request){(statusCode,result, error,data) in
             requestComplation(statusCode,result,error,data)
        }
    } 
    ...
    public func getDataPlanAsync(request:GetDataPlanRequest,requestComplation:@escaping ExecuteResult<GetDataPlanResult>) throws {
        httpdnsJDCloudClient = self
        try GetDataPlanExecutor(jdCloudClient: httpdnsJDCloudClient).executeAsync(request: request){(statusCode,result, error,data) in
             requestComplation(statusCode,result,error,data)
        }
    } 
