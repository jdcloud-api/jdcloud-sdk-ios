...
public class ModifyNetworkSecurityGroupRulesRequest:JdCloudRequest
{
    ...
    public override func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: ModifyNetworkSecurityGroupRulesRequestRequestCodingKeys.self)
        try container.encode(modifySecurityGroupRuleSpecs, forKey: .modifySecurityGroupRuleSpecs)
