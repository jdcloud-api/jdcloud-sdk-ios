...
public class AddRouteTableRulesRequest:JdCloudRequest
{
    ...
    public override func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: AddRouteTableRulesRequestRequestCodingKeys.self)
        try container.encode(routeTableRuleSpecs, forKey: .routeTableRuleSpecs)
