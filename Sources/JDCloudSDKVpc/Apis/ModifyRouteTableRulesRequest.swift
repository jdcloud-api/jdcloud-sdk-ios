...
public class ModifyRouteTableRulesRequest:JdCloudRequest
{
    ...
    public override func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: ModifyRouteTableRulesRequestRequestCodingKeys.self)
        try container.encode(modifyRouteTableRuleSpecs, forKey: .modifyRouteTableRuleSpecs)
