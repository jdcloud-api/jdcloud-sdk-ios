...
public class AddNetworkAclRulesRequest:JdCloudRequest
{
    ...
    public override func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: AddNetworkAclRulesRequestRequestCodingKeys.self)
        try container.encode(networkAclRuleSpecs, forKey: .networkAclRuleSpecs)
