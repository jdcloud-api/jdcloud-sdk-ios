...
public class CreateNetworkInterfaceRequest:JdCloudRequest
{
    ...
    public override func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: CreateNetworkInterfaceRequestRequestCodingKeys.self)
        try container.encode(subnetId, forKey: .subnetId)
        try container.encode(az, forKey: .az)
        try container.encode(networkInterfaceName, forKey: .networkInterfaceName)
        try container.encode(primaryIpAddress, forKey: .primaryIpAddress)
        try container.encode(secondaryIpAddresses, forKey: .secondaryIpAddresses)
        try container.encode(secondaryIpCount, forKey: .secondaryIpCount)
        try container.encode(securityGroups, forKey: .securityGroups)
        try container.encode(sanityCheck, forKey: .sanityCheck)
