...
public class CreateImageRequest:JdCloudRequest
{
    ...
    public init(regionId: String,name:String,description:String,instanceId:String){
        self.name = name
    ...
    public override func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: CreateImageRequestRequestCodingKeys.self)
        try container.encode(name, forKey: .name)
        try container.encode(description, forKey: .description)
        try container.encode(dataDisks, forKey: .dataDisks)
