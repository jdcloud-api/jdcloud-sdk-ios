...
public class CopyImagesRequest:JdCloudRequest
{
    ...
    public override func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: CopyImagesRequestRequestCodingKeys.self)
        try container.encode(sourceImageIds, forKey: .sourceImageIds)
        try container.encode(destinationRegion, forKey: .destinationRegion)
