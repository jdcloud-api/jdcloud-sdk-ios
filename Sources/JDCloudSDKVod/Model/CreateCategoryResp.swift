...
///  创建分类响应信息
@objc(CreateCategoryResp)
public class CreateCategoryResp:NSObject,Codable{
    /// 分类ID
    var id:Int64?
    /// 分类名称
    var name:String?
    ...
    enum CreateCategoryRespCodingKeys: String, CodingKey {
        case id
        case name
        case level
        case parentId
    ...
    required public init(from decoder: Decoder) throws {
        let decoderContainer = try decoder.container(keyedBy: CreateCategoryRespCodingKeys.self)
...
public extension CreateCategoryResp{
    func encode(to encoder: Encoder) throws {
        var encoderContainer = encoder.container(keyedBy: CreateCategoryRespCodingKeys.self)
