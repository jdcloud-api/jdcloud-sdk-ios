...
@objc(GetURLRuleResp)
public class GetURLRuleResp:NSObject,Codable{
    /// 规则类型，取值 &#39;url&#39;
    var ruleType:String?
    /// 规则配置对象
    var config:Config?
    ...
    enum GetURLRuleRespCodingKeys: String, CodingKey {
        case ruleType
        case config
        case enabled
        case createTime
    ...
    required public init(from decoder: Decoder) throws {
        let decoderContainer = try decoder.container(keyedBy: GetURLRuleRespCodingKeys.self)
...
public extension GetURLRuleResp{
    func encode(to encoder: Encoder) throws {
        var encoderContainer = encoder.container(keyedBy: GetURLRuleRespCodingKeys.self)
