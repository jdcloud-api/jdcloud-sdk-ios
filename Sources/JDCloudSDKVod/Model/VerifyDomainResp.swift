...
///  校验域名结果
@objc(VerifyDomainResp)
public class VerifyDomainResp:NSObject,Codable{
    /// 校验域名
    ...
    enum VerifyDomainRespCodingKeys: String, CodingKey {
        case domainName
        case verified
        case icpInfo
    }
    ...
    required public init(from decoder: Decoder) throws {
        let decoderContainer = try decoder.container(keyedBy: VerifyDomainRespCodingKeys.self)
...
public extension VerifyDomainResp{
    func encode(to encoder: Encoder) throws {
        var encoderContainer = encoder.container(keyedBy: VerifyDomainRespCodingKeys.self)
