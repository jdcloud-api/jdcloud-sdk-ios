...
///  设置域名头参数请求消息体
@objc(SetHeaderReq)
public class SetHeaderReq:NSObject,Codable{
    /// 头参数名
    ...
    enum SetHeaderReqCodingKeys: String, CodingKey {
        case headerName
        case headerValue
        case headerType
    }
    ...
    required public init(from decoder: Decoder) throws {
        let decoderContainer = try decoder.container(keyedBy: SetHeaderReqCodingKeys.self)
...
public extension SetHeaderReq{
    func encode(to encoder: Encoder) throws {
        var encoderContainer = encoder.container(keyedBy: SetHeaderReqCodingKeys.self)
