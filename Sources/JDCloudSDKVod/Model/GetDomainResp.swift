...
///  查询域名响应信息
@objc(GetDomainResp)
public class GetDomainResp:NSObject,Codable{
    /// 域名ID
    var id:String?
    /// 域名名称
    var name:String?
    ...
    enum GetDomainRespCodingKeys: String, CodingKey {
        case id
        case name
        case cname
        case source
    ...
    required public init(from decoder: Decoder) throws {
        let decoderContainer = try decoder.container(keyedBy: GetDomainRespCodingKeys.self)
...
public extension GetDomainResp{
    func encode(to encoder: Encoder) throws {
        var encoderContainer = encoder.container(keyedBy: GetDomainRespCodingKeys.self)
