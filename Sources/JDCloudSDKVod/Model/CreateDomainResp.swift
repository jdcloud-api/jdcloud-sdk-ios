...
///  查询域名响应信息
@objc(CreateDomainResp)
public class CreateDomainResp:NSObject,Codable{
    /// 域名ID
    var id:String?
    /// 域名名称
    var name:String?
    ...
    enum CreateDomainRespCodingKeys: String, CodingKey {
        case id
        case name
        case cname
        case source
    ...
    required public init(from decoder: Decoder) throws {
        let decoderContainer = try decoder.container(keyedBy: CreateDomainRespCodingKeys.self)
...
public extension CreateDomainResp{
    func encode(to encoder: Encoder) throws {
        var encoderContainer = encoder.container(keyedBy: CreateDomainRespCodingKeys.self)
