...
///  修改水印请求信息
@objc(UpdateWatermarkReq)
public class UpdateWatermarkReq:NSObject,Codable{
    /// 水印ID
    var id:Int64?
    /// 水印名称
    var name:String?
    ...
    enum UpdateWatermarkReqCodingKeys: String, CodingKey {
        case id
        case name
        case imgUrl
        case width
    ...
    required public init(from decoder: Decoder) throws {
        let decoderContainer = try decoder.container(keyedBy: UpdateWatermarkReqCodingKeys.self)
...
public extension UpdateWatermarkReq{
    func encode(to encoder: Encoder) throws {
        var encoderContainer = encoder.container(keyedBy: UpdateWatermarkReqCodingKeys.self)
