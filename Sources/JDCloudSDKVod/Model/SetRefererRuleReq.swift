...
@objc(SetRefererRuleReq)
public class SetRefererRuleReq:NSObject,Codable{
    /// 规则类型，取值 &#39;referer&#39;
    var ruleType:String?
    /// 规则配置对象
    var config:Config?
    ...
    enum SetRefererRuleReqCodingKeys: String, CodingKey {
        case ruleType
        case config
        case enabled
    }
    ...
    required public init(from decoder: Decoder) throws {
        let decoderContainer = try decoder.container(keyedBy: SetRefererRuleReqCodingKeys.self)
...
public extension SetRefererRuleReq{
    func encode(to encoder: Encoder) throws {
        var encoderContainer = encoder.container(keyedBy: SetRefererRuleReqCodingKeys.self)
