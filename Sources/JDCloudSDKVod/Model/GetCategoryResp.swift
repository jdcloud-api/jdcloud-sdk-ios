...
///  查询分类响应信息
@objc(GetCategoryResp)
public class GetCategoryResp:NSObject,Codable{
    /// 分类ID
    var id:Int64?
    /// 分类名称
    var name:String?
    ...
    enum GetCategoryRespCodingKeys: String, CodingKey {
        case id
        case name
        case level
        case parentId
    ...
    required public init(from decoder: Decoder) throws {
        let decoderContainer = try decoder.container(keyedBy: GetCategoryRespCodingKeys.self)
...
public extension GetCategoryResp{
    func encode(to encoder: Encoder) throws {
        var encoderContainer = encoder.container(keyedBy: GetCategoryRespCodingKeys.self)
