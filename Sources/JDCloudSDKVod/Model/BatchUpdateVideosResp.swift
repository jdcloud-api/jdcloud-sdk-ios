...
@objc(BatchUpdateVideosResp)
public class BatchUpdateVideosResp:NSObject,Codable{
    /// UpdateVideoIds
    ...
    enum BatchUpdateVideosRespCodingKeys: String, CodingKey {
        case updateVideoIds
    ...
    required public init(from decoder: Decoder) throws {
        let decoderContainer = try decoder.container(keyedBy: BatchUpdateVideosRespCodingKeys.self)
...
public extension BatchUpdateVideosResp{
    func encode(to encoder: Encoder) throws {
        var encoderContainer = encoder.container(keyedBy: BatchUpdateVideosRespCodingKeys.self)
