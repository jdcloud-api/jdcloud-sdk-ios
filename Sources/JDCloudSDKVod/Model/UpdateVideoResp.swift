...
///  updateVideoResp
@objc(UpdateVideoResp)
public class UpdateVideoResp:NSObject,Codable{
    /// 视频ID
    var id:String?
    /// 视频名称
    var name:String?
    ...
    enum UpdateVideoRespCodingKeys: String, CodingKey {
        case id
        case name
    ...
    required public init(from decoder: Decoder) throws {
        let decoderContainer = try decoder.container(keyedBy: UpdateVideoRespCodingKeys.self)
...
public extension UpdateVideoResp{
    func encode(to encoder: Encoder) throws {
        var encoderContainer = encoder.container(keyedBy: UpdateVideoRespCodingKeys.self)
