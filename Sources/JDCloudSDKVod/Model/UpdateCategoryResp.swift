...
///  修改分类响应信息
@objc(UpdateCategoryResp)
public class UpdateCategoryResp:NSObject,Codable{
    /// 分类ID
    var id:Int64?
    /// 分类名称
    var name:String?
    ...
    enum UpdateCategoryRespCodingKeys: String, CodingKey {
        case id
        case name
        case level
        case parentId
    ...
    required public init(from decoder: Decoder) throws {
        let decoderContainer = try decoder.container(keyedBy: UpdateCategoryRespCodingKeys.self)
...
public extension UpdateCategoryResp{
    func encode(to encoder: Encoder) throws {
        var encoderContainer = encoder.container(keyedBy: UpdateCategoryRespCodingKeys.self)
