...
///  修改转码模板响应信息
@objc(UpdateTranscodeTemplateResp)
public class UpdateTranscodeTemplateResp:NSObject,Codable{
    /// 模板ID
    var id:Int64?
    /// 模板名称
    var name:String?
    ...
    enum UpdateTranscodeTemplateRespCodingKeys: String, CodingKey {
        case id
        case name
        case video
        case audio
    ...
    required public init(from decoder: Decoder) throws {
        let decoderContainer = try decoder.container(keyedBy: UpdateTranscodeTemplateRespCodingKeys.self)
...
public extension UpdateTranscodeTemplateResp{
    func encode(to encoder: Encoder) throws {
        var encoderContainer = encoder.container(keyedBy: UpdateTranscodeTemplateRespCodingKeys.self)
