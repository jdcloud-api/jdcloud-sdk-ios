...
///  查询水印响应信息
@objc(GetWatermarkResp)
public class GetWatermarkResp:NSObject,Codable{
    /// 水印ID
    var id:Int64?
    /// 水印名称
    var name:String?
    ...
    enum GetWatermarkRespCodingKeys: String, CodingKey {
        case id
        case name
        case imgUrl
        case width
    ...
    required public init(from decoder: Decoder) throws {
        let decoderContainer = try decoder.container(keyedBy: GetWatermarkRespCodingKeys.self)
...
public extension GetWatermarkResp{
    func encode(to encoder: Encoder) throws {
        var encoderContainer = encoder.container(keyedBy: GetWatermarkRespCodingKeys.self)
