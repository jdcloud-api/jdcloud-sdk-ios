...
///  获取域名IP访问控制规则配置响应消息体
@objc(GetIPRuleResp)
public class GetIPRuleResp:NSObject,Codable{
    /// 规则类型，取值 &#39;ip&#39;
    var ruleType:String?
    /// 规则配置对象
    var config:Config?
    ...
    enum GetIPRuleRespCodingKeys: String, CodingKey {
        case ruleType
        case config
        case enabled
        case createTime
    ...
    required public init(from decoder: Decoder) throws {
        let decoderContainer = try decoder.container(keyedBy: GetIPRuleRespCodingKeys.self)
...
public extension GetIPRuleResp{
    func encode(to encoder: Encoder) throws {
        var encoderContainer = encoder.container(keyedBy: GetIPRuleRespCodingKeys.self)
