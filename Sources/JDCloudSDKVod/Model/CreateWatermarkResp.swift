...
///  创建水印响应信息
@objc(CreateWatermarkResp)
public class CreateWatermarkResp:NSObject,Codable{
    /// 水印ID
    var id:Int64?
    /// 水印名称
    var name:String?
    ...
    enum CreateWatermarkRespCodingKeys: String, CodingKey {
        case id
        case name
        case imgUrl
        case width
    ...
    required public init(from decoder: Decoder) throws {
        let decoderContainer = try decoder.container(keyedBy: CreateWatermarkRespCodingKeys.self)
...
public extension CreateWatermarkResp{
    func encode(to encoder: Encoder) throws {
        var encoderContainer = encoder.container(keyedBy: CreateWatermarkRespCodingKeys.self)
