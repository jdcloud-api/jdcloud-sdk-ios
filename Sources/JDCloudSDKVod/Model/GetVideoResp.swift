...
///  getVideoResp
@objc(GetVideoResp)
public class GetVideoResp:NSObject,Codable{
    /// 视频ID
    var id:String?
    /// 视频名称
    var name:String?
    ...
    enum GetVideoRespCodingKeys: String, CodingKey {
        case id
        case name
    ...
    required public init(from decoder: Decoder) throws {
        let decoderContainer = try decoder.container(keyedBy: GetVideoRespCodingKeys.self)
...
public extension GetVideoResp{
    func encode(to encoder: Encoder) throws {
        var encoderContainer = encoder.container(keyedBy: GetVideoRespCodingKeys.self)
