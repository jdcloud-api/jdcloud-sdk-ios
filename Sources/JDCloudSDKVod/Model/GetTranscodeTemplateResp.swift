...
///  查询转码模板响应信息
@objc(GetTranscodeTemplateResp)
public class GetTranscodeTemplateResp:NSObject,Codable{
    /// 模板ID
    var id:Int64?
    /// 模板名称
    var name:String?
    ...
    enum GetTranscodeTemplateRespCodingKeys: String, CodingKey {
        case id
        case name
        case video
        case audio
    ...
    required public init(from decoder: Decoder) throws {
        let decoderContainer = try decoder.container(keyedBy: GetTranscodeTemplateRespCodingKeys.self)
...
public extension GetTranscodeTemplateResp{
    func encode(to encoder: Encoder) throws {
        var encoderContainer = encoder.container(keyedBy: GetTranscodeTemplateRespCodingKeys.self)
