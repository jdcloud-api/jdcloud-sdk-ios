...
///  修改分类请求信息
@objc(UpdateCategoryReq)
public class UpdateCategoryReq:NSObject,Codable{
    /// 分类ID
    var id:Int64?
    /// 分类名称
    var name:String?
    ...
    enum UpdateCategoryReqCodingKeys: String, CodingKey {
        case id
        case name
        case level
        case parentId
    ...
    required public init(from decoder: Decoder) throws {
        let decoderContainer = try decoder.container(keyedBy: UpdateCategoryReqCodingKeys.self)
...
public extension UpdateCategoryReq{
    func encode(to encoder: Encoder) throws {
        var encoderContainer = encoder.container(keyedBy: UpdateCategoryReqCodingKeys.self)
