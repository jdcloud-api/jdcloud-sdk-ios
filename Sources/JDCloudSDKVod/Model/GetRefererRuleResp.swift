...
///  域名REFERER访问控制规则配置响应消息体
@objc(GetRefererRuleResp)
public class GetRefererRuleResp:NSObject,Codable{
    /// 规则类型，取值 &#39;referer&#39;
    var ruleType:String?
    /// 规则配置对象
    var config:Config?
    ...
    enum GetRefererRuleRespCodingKeys: String, CodingKey {
        case ruleType
        case config
        case enabled
        case createTime
    ...
    required public init(from decoder: Decoder) throws {
        let decoderContainer = try decoder.container(keyedBy: GetRefererRuleRespCodingKeys.self)
...
public extension GetRefererRuleResp{
    func encode(to encoder: Encoder) throws {
        var encoderContainer = encoder.container(keyedBy: GetRefererRuleRespCodingKeys.self)
