...
///  修改水印请求信息
@objc(UpdateTranscodeTemplateReq)
public class UpdateTranscodeTemplateReq:NSObject,Codable{
    /// 模板ID
    var id:Int64?
    /// 模板名称
    var name:String?
    ...
    enum UpdateTranscodeTemplateReqCodingKeys: String, CodingKey {
        case id
        case name
        case video
        case audio
    ...
    required public init(from decoder: Decoder) throws {
        let decoderContainer = try decoder.container(keyedBy: UpdateTranscodeTemplateReqCodingKeys.self)
...
public extension UpdateTranscodeTemplateReq{
    func encode(to encoder: Encoder) throws {
        var encoderContainer = encoder.container(keyedBy: UpdateTranscodeTemplateReqCodingKeys.self)
