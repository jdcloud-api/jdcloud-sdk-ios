...
///  修改水印响应信息
@objc(UpdateWatermarkResp)
public class UpdateWatermarkResp:NSObject,Codable{
    /// 水印ID
    var id:Int64?
    /// 水印名称
    var name:String?
    ...
    enum UpdateWatermarkRespCodingKeys: String, CodingKey {
        case id
        case name
        case imgUrl
        case width
    ...
    required public init(from decoder: Decoder) throws {
        let decoderContainer = try decoder.container(keyedBy: UpdateWatermarkRespCodingKeys.self)
...
public extension UpdateWatermarkResp{
    func encode(to encoder: Encoder) throws {
        var encoderContainer = encoder.container(keyedBy: UpdateWatermarkRespCodingKeys.self)
