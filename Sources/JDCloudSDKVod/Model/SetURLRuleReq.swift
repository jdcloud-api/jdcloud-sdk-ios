...
@objc(SetURLRuleReq)
public class SetURLRuleReq:NSObject,Codable{
    /// 规则类型，取值 &#39;url&#39;
    var ruleType:String?
    /// 规则配置对象
    var config:Config?
    ...
    enum SetURLRuleReqCodingKeys: String, CodingKey {
        case ruleType
        case config
        case enabled
    }
    ...
    required public init(from decoder: Decoder) throws {
        let decoderContainer = try decoder.container(keyedBy: SetURLRuleReqCodingKeys.self)
...
public extension SetURLRuleReq{
    func encode(to encoder: Encoder) throws {
        var encoderContainer = encoder.container(keyedBy: SetURLRuleReqCodingKeys.self)
