...
///  updateVideoReq
@objc(UpdateVideoReq)
public class UpdateVideoReq:NSObject,Codable{
    /// 视频ID
    var id:String?
    /// 视频名称
    var name:String?
    ...
    enum UpdateVideoReqCodingKeys: String, CodingKey {
        case id
        case name
        case categoryId
        case tags
    ...
    required public init(from decoder: Decoder) throws {
        let decoderContainer = try decoder.container(keyedBy: UpdateVideoReqCodingKeys.self)
...
public extension UpdateVideoReq{
    func encode(to encoder: Encoder) throws {
        var encoderContainer = encoder.container(keyedBy: UpdateVideoReqCodingKeys.self)
