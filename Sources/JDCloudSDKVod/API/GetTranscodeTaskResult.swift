...
/// 获取转码任务信息
@objc(GetTranscodeTaskResult)
public class GetTranscodeTaskResult:NSObject,JdCloudResult
{
    /// 任务ID
    var taskId:Int64?
    ...
    enum GetTranscodeTaskResultCodingKeys: String, CodingKey {
        case taskId
        case name
        case mediaType
        case status
    ...
    required public init(from decoder: Decoder) throws {
        let decoderContainer = try decoder.container(keyedBy: GetTranscodeTaskResultCodingKeys.self)
...
public extension GetTranscodeTaskResult{
    func encode(to encoder: Encoder) throws {
        var encoderContainer = encoder.container(keyedBy: GetTranscodeTaskResultCodingKeys.self)
