...
///  添加转码模板
public class TranscodesCreateRequest:JdCloudRequest
{
    /// 模板名称
    var name:String
    ...
    public init(regionId: String,name:String,format:String,videoCodec:String,videoCoderate:Int,videoFramerate:String,audioCodec:String,audioCoderate:Int,sampleRate:Int,channel:Int){
        self.name = name
        self.format = format
    ...
    enum TranscodesCreateRequestRequestCodingKeys: String, CodingKey {
        case name
        case format
        case videoCodec
        case width
    ...
    public override func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: TranscodesCreateRequestRequestCodingKeys.self)
